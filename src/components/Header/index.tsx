...
import { CarrinhoAmount, CarrinhoContainer, HeaderContainer, LoginButton } from "./styles";
...
const Header = () => {
    ...
    const [loginTooltipContent, setLoginTooltipContent] = useState('Clique aqui parar fazer login')

    const loginLogout = async () => keycloak.authenticated ? keycloak.logout() :  keycloak.login()
    ...
    return (
        <HeaderContainer>
            ...
            <div>
                <LoginButton onClick={loginLogout} data-tooltip-id="login" data-tooltip-content={loginTooltipContent}>
